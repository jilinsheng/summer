...
/**
 * BizTOptcheckchilditem entity. @author MyEclipse Persistence Tools
 */

public class BizTOptcheckchilditem  implements java.io.Serializable {
    ...
    /** default constructor */
    public BizTOptcheckchilditem() {
    }

    
    /** full constructor */
    public BizTOptcheckchilditem(BigDecimal optcheckchildId, BigDecimal policychildId, Double itemmoney1, Double itemmoney2, Double itemmoney3, Double itemmoney4, Double itemmoney5, Double itemmoney, BigDecimal itemresultoper, Date itemresultdt) {
