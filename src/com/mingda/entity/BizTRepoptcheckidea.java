...
/**
 * BizTRepoptcheckidea entity. @author MyEclipse Persistence Tools
 */

public class BizTRepoptcheckidea  implements java.io.Serializable {


    // Fields    

     private BigDecimal repoptcheckideaId;
    ...
    /** default constructor */
    public BizTRepoptcheckidea() {
    }

    
    /** full constructor */
    public BizTRepoptcheckidea(BigDecimal optaccId, BigDecimal optcheckideaId, BigDecimal optcheckId, BigDecimal depth, String appideaman, String apparea, Date rebegdt, Date reenddt, BigDecimal appresult, Date apptime, String note, BigDecimal checkoper, Date checkdt, String status) {
    ...
    public BigDecimal getRepoptcheckideaId() {
        return this.repoptcheckideaId;
    }
    
    public void setRepoptcheckideaId(BigDecimal repoptcheckideaId) {
        this.repoptcheckideaId = repoptcheckideaId;
    }
