...
/**
 * ImplTPaperinfo2 entity. @author MyEclipse Persistence Tools
 */

public class ImplTPaperinfo2 implements java.io.Serializable {

	// Fields

	private Long paperinfo2Id;
	...
	/** default constructor */
	public ImplTPaperinfo2() {
	}

	/** full constructor */
	public ImplTPaperinfo2(ImplTPaperrecord implTPaperrecord,
	...
	public Long getPaperinfo2Id() {
		return paperinfo2Id;
	}

	public void setPaperinfo2Id(Long paperinfo2Id) {
		this.paperinfo2Id = paperinfo2Id;
	}
