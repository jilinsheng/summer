...
public class FamilyChildGetFormServlet extends HttpServlet {
	static Logger log = Logger.getLogger(FamilyChildGetFormServlet.class);
	/**
	 * Constructor of the object.
	 */
	public FamilyChildGetFormServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.write("</table>");
		out.write("<input type=\"button\" value=\"保存信息\" onclick=\"familychildSave()\"/>");
		out.write("</form>");
		out.flush();
		out.close();
	}
