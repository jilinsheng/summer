 ...
 */
public class NoticemanagequeryAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (curpage == null || curpage.equals("")) {
				...
				sql = "select *  from net_t_notice n where n.noticetype = '1' and n.organ like '"
			...
			while (rs.next()) {
				html += "<tr><td>"
						...
						+ "</td><td><a href=\"noticebrowser.do?reltable=NET_T_NOTICE&relid="
						+ rs.getString("notice_id")
						+ "\" target=\"_blank\">查看</a>"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"noticemanage.do?reltable=NET_T_NOTICE&relid="
						+ rs.getString("notice_id")
		...
		return mapping.findForward("noticemanagequery");
	}
}