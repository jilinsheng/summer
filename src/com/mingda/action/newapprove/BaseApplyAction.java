...
public class BaseApplyAction extends Action {
	static Logger log = Logger.getLogger(BaseApplyAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		padao.savePolicyDAO(familyId, checkflag, optcheckId, onno, policyId,
				money);

		String sql = "select k.optcheck_id, k.policy_id, k.checkflag1, "
				+ " k.checkflag2,  k.checkflag3,   k.moneyflag, k.ifover, "
				+ " k.result, k.checkmoney , fam.family_id,  fam.familyno, fam.organization_id, "
				+ " fam.ensurecount,  fam.dessaltype,  fam.saltype, "
				+ " fs.flag,  fs.money, (  decode( sign(  fam.ensurecount-3),1,3,fam.ensurecount ) * b.planmoney) as countmoney, "
		...
		return mapping.findForward("baseapplyview");
	}
