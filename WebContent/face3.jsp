...
<form id="login" action="http://10.1.3.14:8080/mas/login.action" method="post">
<div id="facebg">
  <div class="face"> 
	...
	<table width="210" border="0"  id="loginform">
       <tr> 
        ...
        <td>
        <input type="text" id="login_userDTO_accout" name="userDTO.accout" class="editbox"/>
        </td>
      </tr>
      <tr> 
	  	<td class="facefont">密&nbsp;&nbsp;码</td>
        <td>
        <input type="password" id="login_userDTO_pwd" name="userDTO.pwd" class="editbox"/>
        </td>
      </tr>
    </table>
  </div>
