	    	...
	    	<td>
	    		<table class="tablexiu"width="100%" border="0" cellspacing="0" cellpadding="0">
			    	...
			    	<tr align="center" class = 'itemstyle'>
				        ...
				        <td><span>字段长度</span></td>
				        <td><input style="width:100%;text-align:right;" type="text" id=""></input></td>
			    	</tr>
			    	<tr align="center" class = 'itemstyle'>
			    		<td><span>小数位数</span></td>
				        <td><input style="width:100%;text-align:right;" type="text" id=""></input></td>
				        <td><span>默认值</span></td>
				        <td><input style="width:100%;text-align:right;" type="text" id=""></input></td>
			    	</tr>    	
			    	<tr align="center" class = 'itemstyle'>
				        ...
				        <td><input style="width:100%;text-align:right;" type="text" id=""></input></td>
				        <td><span>是否可空</span></td>
				        <td><input type="checkbox" id=""></input>可空</td>
			    	</tr>
			    	<tr align="center" class = 'itemstyle'>
			    		<td><span>排序</span></td>
				        <td><input style="width:100%;text-align:right;" type="text" id=""></input></td>
				        <td><span>在用状态</span></td>
				        <td><input type="checkbox" id=""></input>在用</td>
			    	</tr>
			    </table>
	    	</td>    	
    	</tr>
