...
<html>
  <head>
	...
	<script type="text/javascript">	
			...
			//查询条件
		   	...
		   	if(selmode=="family"){
				...
				selselect = "INFO_T_FAMILY.FAMILY_ID";				
		   		...
		   		//成员
		   		selselect = "INFO_T_MEMBER.MEMBER_ID";		   		
		   	}
		...
		//保存操作
		function SaveClassSql(physql,locsql){
			var sphysql = "",slocsql = "";			
			//
			sphysql = physql;			
    		slocsql = locsql;    			
			//
		    if (!confirm("确定保存["+selname+"]分类条件?")) {
		        return;
		    }
			//
			//
		    $.post("page/info/search/TableInfoServlet",            //服务器页面地址
		        {
		            action: "updateClassSql",             //action参数
		            sid: selid,
		            sphysql: sphysql,
		            slocsql: slocsql        
		        },
		...
		function GetClassSqlItem() {
		    ...
		    $.post("page/info/search/TableInfoServlet",   //服务器页面地址
		        {
		            action: "getClassSqlItem",             //action参数
		            sid: selid,
		            mode: mode         
		        },
		        function(result) {                    	//回调函数
  		...
  		<table width="100%" border="0" cellspacing="0" cellpadding="0">	   		   		
	    	<tr align="center">
	    			...
	    			<table width="100%" border="0" cellspacing="0" cellpadding="0">	   		   		
				    	<tr align="center">
				    		<td valign="top" width="40%">
				    			<fieldset  class='list'>
				    			<legend  class='legend'>分类条件设置</legend>
	    		...
	    		<td valign="top" width="60%">	    		
	    			<fieldset  class='list'>
	    			<legend  class='legend'>[<%=reqname%>]分类条件属性</legend>  
	    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
	    					<tr align="center" class = 'titles'>	
	    						<td valign="top">
	    							<input type="radio" name="rd" id="rdc" value="rdc" onclick="GetClassSqlItem()" checked />选择条件语句
									<input type="radio" name="rd" id="rdp" value="rdp" onclick="GetClassSqlItem()" />标准SQL语句
	    						</td>
	    					</tr>	    					
					    	<tr align="center">
					    		<td valign="top">
			          	...
			          	<div class = "titles">
						  	...
						  	<input type='button' value='重置' onclick="GetClassSqlItem()"></input>
