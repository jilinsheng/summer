...
<html>
  ...
  <script  type="text/javascript">
	...
	function getCheckResultForXml(mode,btnmode){
		...
		jendpage = selendpage;
		//过滤查询==============================================
		jfmno = $("#reqfmid").val();	//家庭编号	
		jfmname = $("#reqfm").val();	//户主姓名
	   		...
	   		<td class = "myspace" colspan = "3">
	   			<div id = "menutabs">
	   				<ul id="menus" class="menu">
	   					<li id="li6" class="default"> 全部名单 </li>	   					
				    	<li id="li0" class="default"> 新增审批 </li>
				    	<li id='li1' class='default'> 调整复查 </li>				    	
				    	<li id='li2' class='default'> 不符合条件 </li>
				    	<li id='li3' class='default'> 重新审批 </li>
				    	<li id='li4' class='default'> 上期顺延 </li>
				    	<li id='li5' class='default'> 已审名单 </li>				    	
				    </ul>
	   			</div>
	   		</td>
	   	</tr>
	   	<tr>
	   		<td class = "myspace" valign="top">
	   			<div id='checkresultcon'>
	   				<fieldset><legend>查询选项<span id = 'spanaccdesc'></span></legend>
				  					...
				  					<table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
				  						<tr valign='middle' style = 'display:none;'>							  				
							  				<td align='center' valign='middle' style = 'font-size:13px;' class='colValue'  colspan = '3'>
							  					家庭编号<input type="text" id = "reqfmid" size = '15'></input>
							  					户主姓名<input type="text" id = "reqfm"  size = '8'></input>
							  					<input type='checkbox' name='chbfm' id='chbfm' checked='checked'>模糊							  												  					
							  				</td>					  				
							  			</tr>				  						
							  			<tr valign='middle'>								  										  							  				
							  				...
							  				<td align='center' valign='middle' style = 'font-size:13px;' class='colValue'>
							  					<span style = "color: #6BA6FF;">排序选择</span>
	  		...
	  		<table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
	  			<tr valign='middle'>	  						
					...
					<td width = "480" align='right' valign='middle' class='mybackground myspace'>
						...
						<button class = 'btn' id = 'btnallpagemoney' onclick="CallMoneyIdea()">按定额审批选中</button>
						<button class = 'btn' id = 'btnallmoney' onclick='getCheckResultForXml("sql","allmoney");'>按定额审批全部</button>
					</td> 				
	  			</tr>
...
<script  type="text/javascript">
	...
	function QueryPage(tab){	
		...
		var qdel = "<option value='7'>不达标</option>";
		//
		var iall = "<option value='0'>全部</option>";
		var inew = "<option value='1'>未审批</option>";
		...
		if(tab == "0"){
	  	...
	  	sqhtml += "</select>";
	  	selectquery.innerHTML = "救助状态"+sqhtml;
	  	sihtml += "</select>";
		selectidea.innerHTML = "审批结果"+sihtml; 
	}
	//批量审批操作栏
...
<script type="text/javascript">
	...
	function infoeditaction(afmid){	
		...
		jBox.open("iframe-jBoxID","iframe",oUrl,"家庭信息维护&updateListMonery();","width="+bWidth+",height="+bHeight
			+",center=true,minimizable=true,resize=true,draggable=false,model=true");
	}
	//
	//获取家庭政策业务相关详细信息
