...
<%	
	...
	if (reqmode == null) {
		//默认为空
		reqmode = "edit";    //编辑状态(edit,add,all)
	}
	//接收qpid
...
<script type="text/javascript">
	...
	function GetMoreCheckIdeaHtml(checkid,memname){
		...
		jBox.open("iframe-jBoxID","iframe",oUrl,"成员评议详细 姓名:"+memname+"","width="+bWidth+",height="+bHeight+",center=true,minimizable=true,resize=true,draggable=false,model=true");		
	}
	//获取分类施保各级审批意见
	function GetChildCheckIdeaHtml(checkid,memname){
		...
		var oUrl = "/db/page/policy/manage/policycheckideahtml.jsp?"+sArgu+"";
		jBox.open("iframe-jBoxID","iframe",oUrl,"分类施保评议详细 姓名:"+memname+"","width="+bWidth+",height="+bHeight+",center=true,minimizable=true,resize=true,draggable=false,model=true");		
	}		
</script>
<script type="text/javascript">
	//取得业务家庭审批列表
	function GetFamilyCheckItemsTable(){
	  	...
	  	//
	    $.post("/db/page/policy/manage/policycheckideamember.do",      //服务器页面地址
	        {
...
<script type="text/javascript">
	...
	function GetCheckPolicyInfosHtml(fmid,memid,fmname){
		...
		jBox.open("iframe-jBoxID","iframe",oUrl,"姓名："+fmname+"  业务相关信息详细","width="+bWidth+",height="+bHeight+",center=true,minimizable=true,resize=true,draggable=false,model=true");			
	}
</script>
<script type="text/javascript">
	//获取家庭政策业务相关标准
