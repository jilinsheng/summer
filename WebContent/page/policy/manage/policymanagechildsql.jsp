  ...
  <head>
	...
	<script type="text/javascript">	
		...
		function SaveChildSql(physql,locsql){
    		...
    		slocsql = locsql;    			
			//
		    if (!confirm("确定保存["+selname+"]分类施保标准条件?")) {
		        return;
		    }
			//
			//
		    $.post("page/policy/manage/PolicyManageServlet",            //服务器页面地址
		        {
		            action: "updatePolicyChildSql",             //action参数
		            sid: selid,
		            sphysql: sphysql,
		            slocsql: slocsql        
		        },
		...
		function GetPolicyChildSqlItem() {
		    ...
		    $.post("page/policy/manage/PolicyManageServlet",   //服务器页面地址
		        {
		            action: "getPolicyChildSqlItem",             //action参数
		            sid: selid,
		            mode: mode         
		        },
		        function(result) {                    	//回调函数
  		...
  		<table width="100%" border="0" cellspacing="0" cellpadding="0">	   		   		
	    	<tr align="center">
	    			...
	    			<table width="100%" border="0" cellspacing="0" cellpadding="0">	   		   		
				    	<tr align="center">
				    		<td valign="top" width="40%">
				    			<fieldset  class='list'>
				    			<legend  class='legend'>分类保障标准设置</legend>
	    		...
	    		<td valign="top" width="60%">	    		
	    			<fieldset  class='list'>
	    			<legend  class='legend'>[<%=reqname%>]分类保障标准属性</legend>  
	    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
	    					<tr align="center" class = 'titles'>	
	    						<td valign="top">
	    							<input type="radio" name="rd" id="rdc" value="rdc" onclick="GetPolicyChildSqlItem()" checked />选择条件语句
									<input type="radio" name="rd" id="rdp" value="rdp" onclick="GetPolicyChildSqlItem()" />标准SQL语句
	    						</td>
	    					</tr>	    					
					    	<tr align="center">
					    		<td valign="top">
			          	...
			          	<div class = "titles">
						  	...
						  	<input type='button' value='重置' onclick="GetPolicyChildSqlItem()"></input>
