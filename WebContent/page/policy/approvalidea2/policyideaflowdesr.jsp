...
<%
	...
	String reqoptdepth = request.getParameter("qoptdepth");
	String reqoptid = request.getParameter("qoptid");
%>
...
<html>
  ...
  <script  type="text/javascript">
	...
	//获取查询XML
	function getIdeaFlowDesrForXml(){
		//
	    $.post("/db/page/policy/approvalidea/policyideapage.do",            //服务器页面地址
	        {
	            action: "getIdeaFlowDesrForXml",            //action参数
	            jpid: pid,
	            joptdepth: optdepth,
	            joptid: optid
	        ...
	        function(result) {                    	//回调函数
	        	ideaflowdesrtb.innerHTML = result; 	        	
	        }
	    );
	}
	//
	function IniPage(){
		...
		pid = "<%=reqpid%>";
		//
		optdepth = "<%=reqoptdepth%>";
		//	
		optid = "<%=reqoptid%>";		 		//查询审批ID
		//
		//获取查询XML
		getIdeaFlowDesrForXml();
	}
  </script>
  <body  onload = "IniPage()">
    	<fieldset><legend>审批流程详细信息</legend>
	  		<div id = "ideaflowdesrtb"></div>
	  	</fieldset>
  </body>
</html>